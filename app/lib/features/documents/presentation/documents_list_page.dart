            ...
            Padding(
               ...
               child: TextField(
                  ...
                  decoration: InputDecoration(
                     ...
                     border: OutlineInputBorder(borderRadius: BorderRadius.circular(InfernalRadius.md), borderSide: BorderSide.none),
                  ),
                  onChanged: (val) => ref.read(documentSearchQueryProvider.notifier).set(val),
               ),
            ),
            Expanded(
               child: docsAsync.when(
                  data: (docs) {
                      if (docs.isEmpty) return const Center(child: Text('No documents found.', style: TextStyle(color: InfernalColors.textMuted)));
                      return ListView.separated(
                          ...
                          itemBuilder: (ctx, idx) {
                              ...
                              return Card(
                                  ...
                                  child: ListTile(
                                      leading: const Icon(Icons.description, color: InfernalColors.arcane),
                                      title: Text(doc.title, style: const TextStyle(color: InfernalColors.textPrimary, fontWeight: FontWeight.bold)),
                                      subtitle: Text(doc.filePath, style: const TextStyle(color: InfernalColors.textSecondary, fontSize: 12)),
